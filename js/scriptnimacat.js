// Data for cards
const cardsData = [
    { title: "Andalusia", description: "En cas que el botó 'Consulteu NIMA' no funcioni, si us plau, premeu <a href='https://www.juntadeandalucia.es/medioambiente/sira-buscador-publico/' target='_blank'>aquí</a>.", modalId: "modal1", iframeSrc: "https://www.juntadeandalucia.es/medioambiente/sira-buscador-publico/", backgroundImage: "../img/andalucia.png" },
    ...
    { title: "Castella i Lleó", description: "En cas que el botó 'Consulteu NIMA' no funcioni, si us plau, premeu <a href='https://servicios.jcyl.es/gaser/verFrmBuscadorGestores.action' target='_blank'>aquí</a>.", modalId: "modal5", iframeSrc: "https://servicios.jcyl.es/gaser/verFrmBuscadorGestores.action", backgroundImage: "../img/cyl.png"  },
    { title: "Castella-La Manxa", description: "En cas que el botó 'Consulteu NIMA' no funcioni, si us plau, premeu <a href='https://ireno.castillalamancha.es/forms/geref000.htm' target='_blank'>aquí</a>.", modalId: "modal6", iframeSrc: "https://ireno.castillalamancha.es/forms/geref000.htm", backgroundImage: "../img/clm.png"  },
    { title: "Catalunya", description: "En cas que el botó 'Consulteu NIMA' no funcioni, si us plau, premeu <a href='https://sdr.arc.cat/modemp/ListGestors.do' target='_blank'>aquí</a>.", modalId: "modal7", iframeSrc: "https://sdr.arc.cat/modemp/ListGestors.do", backgroundImage: "../img/catalunya.png"  },
    ...
    { title: "Galícia", description: "En cas que el botó 'Consulteu NIMA' no funcioni, si us plau, premeu <a href='https://sirga.xunta.gal/nima' target='_blank'>aquí</a>.", modalId: "modal11", iframeSrc: "https://sirga.xunta.gal/nima", backgroundImage: "../img/galicia.png"  },
    { title: "Illes Balears", description: "En cas que el botó 'Consulteu NIMA' no funcioni, si us plau, premeu <a href='https://residus.caib.es/www/regpig/' target='_blank'>aquí</a>.", modalId: "modal12", iframeSrc: "https://residus.caib.es/www/regpig/", backgroundImage: "../img/baleares.png"  },
    { title: "Illes Canàries", description: "En cas que el botó 'Consulteu NIMA' no funcioni, si us plau, premeu <a href='https://www.gobiernodecanarias.org/medioambiente/materias/residuos/registro-de-produccion/buscador-de-productores/' target='_blank'>aquí</a>.", modalId: "modal13", iframeSrc: " ", backgroundImage: "../img/canarias.png"  },
    { title: "La Rioja", description: "En cas que el botó 'Consulteu NIMA' no funcioni, si us plau, premeu <a href='https://www.larioja.org/medio-ambiente/es/residuos/buscador-nimas' target='_blank'>aquí</a>.", modalId: "modal14", iframeSrc: "https://www.larioja.org/medio-ambiente/es/residuos/buscador-nimas", backgroundImage: "../img/larioja.png"  },
    ...
    { title: "Navarra", description: "En cas que el botó 'Consulteu NIMA' no funcioni, si us plau, premeu <a href='https://extra.navarra.es/InformacionPublicaPRTR/RPGR.html#/PGR' target='_blank'>aquí</a>.", modalId: "modal17", iframeSrc: "https://extra.navarra.es/InformacionPublicaPRTR/RPGR.html#/PGR", backgroundImage: "../img/navarra.png"  },
    { title: "País Basc", description: "En cas que el botó 'Consulteu NIMA' no funcioni, si us plau, premeu <a href='https://www.euskadi.eus/informacion/registro-de-produccion-y-gestion-de-residuos/web01-a2inghon/es/' target='_blank'>aquí</a>.", modalId: "modal18", iframeSrc: "https://www.euskadi.eus/informacion/registro-de-produccion-y-gestion-de-residuos/web01-a2inghon/es/", backgroundImage: "../img/paisvasco.png"  },
];
            ...
            <div class="card-flip">
                <div class="card-flip-inner">
                    ...
                    <div class="card-back">
                        ...
                        <br>
                        <button class="btn btn-light" data-bs-toggle="modal" data-bs-target="#${uniqueId}">CONSULTEU NIMA</button>
                    </div>
                </div>
            </div>
        </div>
